...
const TransactionTable = ({ transactions, plan = "anonymous", accountHolder, dateRange }: TransactionTableProps) => {
  ...
  const exportCSV = () => {
    ...
    // Build filename: MoMoSense-[AccountName]-[DateFrom]-to-[DateTo].csv
    ...
    const filename = dateFrom && dateTo
      ? `MoMoSense-${safeName}-${dateFrom}-to-${dateTo}.csv`
      : `MoMoSense-${safeName}-${new Date().toISOString().split("T")[0]}.csv`;
